...
describe 'Visitante realiza uma busca por seguradoras' do
  ...
  it 'a partir do nome do seu produto' do
    ...
    allow(Faraday).to receive(:get).with('http://localhost:4000/api/v1/insurance/iphone11').and_return(fake_response)
    ...
    expect(page).to have_content 'Resultado da Busca: iphone11'
